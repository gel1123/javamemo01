...
class App {
	...
	private static ConcurrentHashMap<String, Long> conc_map = new ConcurrentHashMap<>();
	private static ConcurrentLinkedDeque<String> conc_deque = new ConcurrentLinkedDeque<>();
	private static CopyOnWriteArrayList cp_list = new CopyOnWriteArrayList();
	private static final long S = System.currentTimeMillis();
	private static final int T_NUM = 4;
	private static final CyclicBarrier B = new CyclicBarrier(T_NUM);
