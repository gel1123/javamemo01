...
class UseForkJoinPool {
	...
	public static void main(String[] args) throws InterruptedException, ExecutionException {
		...
		ForkJoinTask<Void> act1 = new RecursiveAction() {
			@Override
			protected void compute() { doSomething("act1"); }
		};
		ForkJoinTask<Void> act2 = new RecursiveAction() {
			@Override
			protected void compute() { doSomething("act2"); }
		};
		ForkJoinTask<Void> act3 = new RecursiveAction() {
			@Override
			protected void compute() { doSomething("act3"); }
		};

		ForkJoinTask<String> task1 = new RecursiveTask<String>() {
			@Override
			protected String compute() { return doSomething("task1"); }
		};
		ForkJoinTask<String> task2 = new RecursiveTask<String>() {
			@Override
			protected String compute() { return doSomething("task2"); }
		};
		ForkJoinTask<String> task3 = new RecursiveTask<String>() {
			@Override
			protected String compute() { return doSomething("task3"); }
		};
